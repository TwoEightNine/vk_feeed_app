package global.msnthrp.feeed.services
...
import global.msnthrp.feeed.utils.writeResponseBody
...
class DownloadFileService : IntentService(NAME) {
    ...
    private fun deliverResult(success: Boolean) {
        l("Result $success for ${file.absolutePath}")
